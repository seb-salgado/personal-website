...
Leti is an iOS emotional wellbeing companion where people can speak their mind and find clarity through conversation.

**Company:** Sounding | **App:** Leti | **Year:** 2025–2026 | **Timeline:** 6 months

[VIDEO: leti-cover — hero video]

---

## My Role

As Sounding's first design hire and the sole product designer on Leti, I led the product design from research through launch. My responsibilities included user research, product strategy, user experience, visual design, brand design, and App Store marketing assets.
...
Leti launched and, just five weeks later, became Sounding's primary product proof point at a16z Speedrun Demo Day and throughout the company's subsequent fundraising efforts, which led to an $8M seed round.
...
[VIDEO: leti-carousel — app feature showcase]

---

## Finding The Higher-Leverage Problem

After Demo Day, the team was focused on improving Leti's path to profitability. Product data showed that more than half of users displayed signs of overwhelm during their first conversation, leading us to explore a dedicated experience for those users.
...
Seven months after launch, Sounding decided to stop investing in Leti and focus on other products with more promising metrics. ROAS on M13 never exceeded 80%, sustainable acquisition costs were difficult to find, and the team did not identify a sufficiently differentiated position against larger players in the category.

Even so, the project achieved its original goals. Leti became Sounding's first shipped product, supported the company's Demo Day and fundraising efforts, helped establish internal product and AI workflows, and generated measurable improvements in conversation quality and engagement.

The outcome was ultimately mixed: Leti was an important company milestone and learning vehicle, but not a proven long term business.
